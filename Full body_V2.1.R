...

{
  ...
  PBPKModel = function(times, state, parameters) {
    with(as.list(c(state, parameters)), {
      ...
      dAgu_ec <- Qgu * (Carterial - (Cgu_ec/Kpgu) * BP) - 0.001 * PER * SA_gu * (Cgu_ec * fuec_gu * funionized_ec - Cgu_icfree/(Kpec_gu * Kpp) * funionized_ic)
      dAki_ec <- Qki * (Carterial - (Cki_ec/Kpki) * BP) - 0.001 * PER * SA_ki * (Cki_ec * fuec_ki * funionized_ec - Cki_icfree/(Kpec_ki * Kpp) * funionized_ic)
      dAli_ec <- Qli * (Carterial - (Cli_ec/Kpli) * BP) - 0.001 * PER * SA_li * (Cli_ec * fuec_li * funionized_ec - Cli_icfree/(Kpec_li * Kpp) * funionized_ic)
      dAlu_ec <- Qlu * (Carterial - (Clu_ec/Kplu) * BP) - 0.001 * PER * SA_lu * (Clu_ec * fuec_lu * funionized_ec - Clu_icfree/(Kpec_lu * Kpp) * funionized_ic)
      dAmu_ec <- Qmu * (Carterial - (Cmu_ec/Kpmu) * BP) - 0.001 * PER * SA_mu * (Cmu_ec * fuec_mu * funionized_ec - Cmu_icfree/(Kpec_mu * Kpp) * funionized_ic)
      dAsk_ec <- Qsk * (Carterial - (Csk_ec/Kpsk) * BP) - 0.001 * PER * SA_sk * (Csk_ec * fuec_sk * funionized_ec - Csk_icfree/(Kpec_sk * Kpp) * funionized_ic)
      dAsp_ec <- Qsp * (Carterial - (Csp_ec/Kpsp) * BP) - 0.001 * PER * SA_sp * (Csp_ec * fuec_sp * funionized_ec - Csp_icfree/(Kpec_sp * Kpp) * funionized_ic)
      dApa_ec <- Qpa * (Carterial - (Cpa_ec/Kppa) * BP) - 0.001 * PER * SA_pa * (Cpa_ec * fuec_pa * funionized_ec - Cpa_icfree/(Kpec_pa * Kpp) * funionized_ic)

      #Intracellular sub-compartment
      dAother_ict <- 0.001 * PER * SA_other * (Che_ec * fuec_he * funionized_ec - Cother_icfree/(Kpec_he * Kpp) * funionized_ic ) - Cother_ict * fu_heart * CLint_heart * (Vother_ic/Vhe)
      dAmyo_ict <- 0.001 * PER * SA_myo * (Che_ec * fuec_he * funionized_ec - Cmyo_icfree/(Kpec_he * Kpp) * funionized_ic ) - Cmyo_ict * fu_heart * CLint_heart * (Vmyo_ic/Vhe)
      dAad_ict <- 0.001 * PER * SA_ad * (Cad_ec * fuec_ad * funionized_ec - Cad_icfree/(Kpec_ad * Kpp) * funionized_ic)
      dAbo_ict <- 0.001 * PER * SA_bo * (Cbo_ec * fuec_bo * funionized_ec - Cbo_icfree/(Kpec_bo * Kpp) * funionized_ic)
      dAbr_ict <- 0.001 * PER * SA_br * (Cbr_ec * fuec_br * funionized_ec - Cbr_icfree/(Kpec_br * Kpp) * funionized_ic)
      dAgu_ict <- 0.001 * PER * SA_gu * (Cgu_ec * fuec_gu * funionized_ec - Cgu_icfree/(Kpec_gu * Kpp) * funionized_ic)
      dAki_ict <- 0.001 * PER * SA_ki * (Cki_ec * fuec_ki * funionized_ec - Cki_icfree/(Kpec_ki * Kpp) * funionized_ic)
      dAli_ict <- 0.001 * PER * SA_li * (Cli_ec * fuec_li * funionized_ec - Cli_icfree/(Kpec_li * Kpp) * funionized_ic)
      dAlu_ict <- 0.001 * PER * SA_lu * (Clu_ec * fuec_lu * funionized_ec - Clu_icfree/(Kpec_lu * Kpp) * funionized_ic)
      dAmu_ict <- 0.001 * PER * SA_mu * (Cmu_ec * fuec_mu * funionized_ec - Cmu_icfree/(Kpec_mu * Kpp) * funionized_ic)
      dAsk_ict <- 0.001 * PER * SA_sk * (Csk_ec * fuec_sk * funionized_ec - Csk_icfree/(Kpec_sk * Kpp) * funionized_ic)
      dAsp_ict <- 0.001 * PER * SA_sp * (Csp_ec * fuec_sp * funionized_ec - Csp_icfree/(Kpec_sp * Kpp) * funionized_ic)
      dApa_ict <- 0.001 * PER * SA_pa * (Cpa_ec * fuec_pa * funionized_ec - Cpa_icfree/(Kpec_pa * Kpp) * funionized_ic)
