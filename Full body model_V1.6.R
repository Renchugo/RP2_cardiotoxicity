...
# Liver (liver/hepatic clearance): metabolism and bile excretion
# Bile excretion: the secretion of bile by the liver into the small intestine, which can then facilitate the elimination of both metabolic products and the substance itself from the body through the feces
rm(list=ls(all=TRUE))
...

{
  ...
  PBPKModel = function(times, state, parameters) {
    with(as.list(c(state, parameters)), {
      ...
      Cendo_ict <- Aendo_ict / Vendo_ic #heart endo intracellular total concentration
      Cmid_ict <- Amid_ict / Vmid_ic #heart mid intracellular total concentration
      Cepi_ict <- Aepi_ict / Vepi_ic #heart epi intracellular total concentration
      ...
      dAendo_ict <-  0.001 * PER * SA_endo * (Cheart_ec * fu_ec * funionized_ec - Cendo_ict/(Kp_endo * Kpp) * funionized_ic ) - Cendo_ict * fu_heart * CLint_heart * (Vendo_ic/Vhe)
      dAmid_ict <-   0.001 * PER * SA_mid * (Cheart_ec * fu_ec * funionized_ec - Cmid_ict/(Kp_mid * Kpp) * funionized_ic ) - Cmid_ict * fu_heart * CLint_heart * (Vmid_ic/Vhe)
      dAepi_ict <-   0.001 * PER * SA_epi * (Cheart_ec * fu_ec * funionized_ec - Cepi_ict/(Kp_epi * Kpp) * funionized_ic ) - Cepi_ict * fu_heart * CLint_heart * (Vepi_ic/Vhe)
      ...
      list(
        ...
        Cheart = Ahe / Vhe,
        Crest = Are / Vre,
        MID_ict = Amid_ict / Vmid_ic,
        ENDO_ict = Aendo_ict / Vendo_ic,
        EPI_ict = Aepi_ict / Vepi_ic,
        EC = Cheart_ec,
