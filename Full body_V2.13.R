...
# Change kon1 * Cother_ict * DNA_other - koff1 * Cother_E1R to kon1 * Cother_ict * Cother_E1 - koff1 * Cother_E1R
# dAheart_ec <-  Qhe * (Carterial - (Cheart_ec/Kphe) * BP) 
# Kp calculation: IW/EW/NL/NP calcuation for organs
# Delete "other" intracellular binding
# Only two results
...
{
  t_end <- 20 #[h] time of the end of simulation
...

{
  ...
  PBPKModel = function(times, state, parameters) {
    with(as.list(c(state, parameters)), {
      ...
      dAheart_ec <-  Qhe * (Carterial - (Cheart_ec/Kphe) * BP) -(0.001 * PER * SA_myo * (Cheart_ec * fuec_he * funionized_ec - Cmyo_ict/(Kpec_he * Kpp) * funionized_ic)) - (0.001 *PER * SA_other * (Cheart_ec * fu_ec * funionized_ec - Cother_ict/(Kpec_he * Kpp) * funionized_ic))
      ...
      dCmyo_ict <- (0.001 * PER * SA_myo * ((Cheart_ec * fu_ec * funionized_ec - Cmyo_ict/(Kpec_he * Kpp) * funionized_ic ) - (Cmyo_ict * fu_heart * CLint_heart * (Vmyo_ic/Vhe))) / Vmyo_ic) - (kon1 * Cmyo_ict * Cmyo_E1 - koff1 * Cmyo_E1R) - (kon2 * Cmyo_ict * Cmyo_E2 - koff2 * Cmyo_E2R ) - (kon3 * Cmyo_ict * Cmyo_E3 - koff3 * Cmyo_E3R )
      ...
      dAve <- inf + Qad * (Cadipose / Kpad * BP) + Qbo * (Cbone / Kpbo * BP) + Qbr * (Cbrain / Kpbr * BP) + Qki* (Ckidney / Kpki * BP) + Qli * (Cliver / Kpli * BP) + Qmu* (Cmuscle / Kpmu * BP) + Qsk* (Cskin / Kpsk * BP)+ Qhe * (Cheart_ec / Kphe * BP) + Qre*(Crest / Kpre * BP) - Qlu * Cvenous - PER * SA_bloodcell * 0.001 * (Cvenous - Cbloodcell) #venous blood
