# Based on V 2.11 
# Standard units in the model: umol / L / g / hour
# Add intracellular binding for organs
...

{
  ...
  inf_dose_mg <- 60 * BSA #[mg] infusion dose according to Pfizer guidance : https://www.pfizermedicalinformation.com/en-us/doxorubicin/dosage-admin
...

{
  ...
  mtDNA_li <- 2.37 #umol/L assume basesd on DNA concentration
  mtDNA_he <- 8.3 
  mtDNA_ki <- 1.62 
  mtDNA_bo <- 1.91 
  mtDNA_gu <- 2.52 
  ...
  PBPKModel = function(times, state, parameters) {
    with(as.list(c(state, parameters)), {
      ...
      dCmyo_ict <- (0.001 * PER * SA_myo * ((Cheart_ec * fu_ec * funionized_ec - Cmyo_ict/(Kpec_he * Kpp) * funionized_ic ) - (Cmyo_ict * fu_heart * CLint_heart * (Vmyo_ic/Vhe))) / Vmyo_ic) - (kon1 * Cmyo_ict * DNA_myo - koff1 * Cmyo_E1R) - (kon2 * Cmyo_ict * Cardiolipin_myo - koff2 * Cmyo_E2R ) - (kon3 * Cmyo_ict * mtDNA_myo - koff3 * Cmyo_E3R )
      ...
      dCad_ict <- (0.001 * PER * SA_ad * ((Cad_ec * fuec_ad * funionized_ec - Cad_ict/(Kpec_ad * Kpp) * funionized_ic)) / Vad_ic) -(kon1 * Cad_ict * DNA_ad - koff1 * Cad_E1R) - (kon2 * Cad_ict * Cardiolipin_ad - koff2 * Cad_E2R) - (kon3 * Cad_ict * mtDNA_ad - koff3 * Cad_E3R) 
      dCbo_ict <- (0.001 * PER * SA_bo * ((Cbo_ec * fuec_bo * funionized_ec - Cbo_ict/(Kpec_bo * Kpp) * funionized_ic)) / Vbo_ic)-(kon1 * Cbo_ict * DNA_bo - koff1 * Cbo_E1R) - (kon2 * Cbo_ict * Cardiolipin_bo - koff2 * Cbo_E2R) - (kon3 * Cbo_ict * mtDNA_bo - koff3 * Cbo_E3R) 
      dCbr_ict <- (0.001 * PER * SA_br * ((Cbr_ec * fuec_br * funionized_ec - Cbr_ict/(Kpec_br * Kpp) * funionized_ic)) / Vbr_ic) -(kon1 * Cbr_ict * DNA_br - koff1 * Cbr_E1R) - (kon2 * Cbr_ict * Cardiolipin_br - koff2 * Cbr_E2R) - (kon3 * Cbr_ict * mtDNA_br - koff3 * Cbr_E3R) 
      dCgu_ict <- (0.001 * PER * SA_gu * ((Cgu_ec * fuec_gu * funionized_ec - Cgu_ict/(Kpec_gu * Kpp) * funionized_ic)) / Vgu_ic) -(kon1 * Cgu_ict * DNA_gu - koff1 * Cgu_E1R) - (kon2 * Cgu_ict * Cardiolipin_gu - koff2 * Cgu_E2R) - (kon3 * Cgu_ict * mtDNA_gu - koff3 * Cgu_E3R) 
      dCki_ict <- (0.001 * PER * SA_ki * ((Cki_ec * fuec_ki * funionized_ec - Cki_ict/(Kpec_ki * Kpp) * funionized_ic)) / Vki_ic) -(kon1 * Cki_ict * DNA_ki - koff1 * Cki_E1R) - (kon2 * Cki_ict * Cardiolipin_ki - koff2 * Cki_E2R) - (kon3 * Cki_ict * mtDNA_ki - koff3 * Cki_E3R) 
      dCli_ict <- (0.001 * PER * SA_li * ((Cli_ec * fuec_li * funionized_ec - Cli_ict/(Kpec_li * Kpp) * funionized_ic)) / Vli_ic) -(kon1 * Cli_ict * DNA_li - koff1 * Cli_E1R) - (kon2 * Cli_ict * Cardiolipin_li - koff2 * Cli_E2R) - (kon3 * Cli_ict * mtDNA_li - koff3 * Cli_E3R) 
      dClu_ict <- (0.001 * PER * SA_lu * ((Clu_ec * fuec_lu * funionized_ec - Clu_ict/(Kpec_lu * Kpp) * funionized_ic)) / Vlu_ic) -(kon1 * Clu_ict * DNA_lu - koff1 * Clu_E1R) - (kon2 * Clu_ict * Cardiolipin_lu - koff2 * Clu_E2R) - (kon3 * Clu_ict * mtDNA_lu - koff3 * Clu_E3R) 
      dCmu_ict <- (0.001 * PER * SA_mu * ((Cmu_ec * fuec_mu * funionized_ec - Cmu_ict/(Kpec_mu * Kpp) * funionized_ic)) / Vmu_ic) -(kon1 * Cmu_ict * DNA_mu - koff1 * Cmu_E1R) - (kon2 * Cmu_ict * Cardiolipin_mu - koff2 * Cmu_E2R) - (kon3 * Cmu_ict * mtDNA_mu - koff3 * Cmu_E3R) 
      dCsk_ict <- (0.001 * PER * SA_sk * ((Csk_ec * fuec_sk * funionized_ec - Csk_ict/(Kpec_sk * Kpp) * funionized_ic)) / Vsk_ic) -(kon1 * Csk_ict * DNA_sk - koff1 * Csk_E1R) - (kon2 * Csk_ict * Cardiolipin_sk - koff2 * Csk_E2R) - (kon3 * Csk_ict * mtDNA_sk - koff3 * Csk_E3R) 
      dCsp_ict <- (0.001 * PER * SA_sp * ((Csp_ec * fuec_sp * funionized_ec - Csp_ict/(Kpec_sp * Kpp) * funionized_ic)) / Vsp_ic)-(kon1 * Csp_ict * DNA_sp - koff1 * Csp_E1R) - (kon2 * Csp_ict * Cardiolipin_sp - koff2 * Csp_E2R) - (kon3 * Csp_ict * mtDNA_sp - koff3 * Csp_E3R) 
      ...
      dCmyo_E2 = - (kon2 * Cmyo_ict * Cardiolipin_myo - koff2 * Cmyo_E2R) 
      ...
      dCad_E2 = - (kon2 * Cad_ict * Cardiolipin_ad - koff2 * Cad_E2R) 
      ...
      dCbo_E2 = - (kon2 * Cbo_ict * Cardiolipin_bo - koff2 * Cbo_E2R) 
      ...
      dCbr_E2 = - (kon2 * Cbr_ict * Cardiolipin_br - koff2 * Cbr_E2R) 
      ...
      dCgu_E2 = - (kon2 * Cgu_ict * Cardiolipin_gu - koff2 * Cgu_E2R) 
      ...
      dCki_E2 = - (kon2 * Cki_ict * Cardiolipin_ki - koff2 * Cki_E2R) 
      ...
      dCli_E2 = - (kon2 * Cli_ict * Cardiolipin_li - koff2 * Cli_E2R) 
      ...
      dClu_E2 = - (kon2 * Clu_ict * Cardiolipin_lu - koff2 * Clu_E2R) 
      ...
      dCmu_E2 = - (kon2 * Cmu_ict * Cardiolipin_mu - koff2 * Cmu_E2R) 
      ...
      dCsk_E2 = - (kon2 * Csk_ict * Cardiolipin_sk - koff2 * Csk_E2R) 
      ...
      dCsp_E2 = - (kon2 * Csp_ict * Cardiolipin_sp - koff2 * Csp_E2R) 
      ...
      dAve <- inf + Qad * (Cadipose / Kpad * BP) + Qbo * (Cbone / Kpbo * BP) + Qbr * (Cbrain / Kpbr * BP) + Qki* (Ckidney / Kpki * BP) + Qli * (Cliver / Kpli * BP) + Qmu* (Cmuscle / Kpmu * BP) + Qsk* (Cskin / Kpsk * BP)+ Qhe * (Cheart_ec / Kpec_he * BP) + Qre*(Crest / Kpre * BP) - Qlu * Cvenous - PER * SA_bloodcell * 0.001 * (Cvenous - Cbloodcell) #venous blood
...
plot(
  ...
  col = "blue",
  xlab = "Time [h]",
  ylab = "Log Plasma Concentration [umol/L]"
)  
...
plot(
  ...
  col = "blue",
  xlab = "Time [h]",
  ylab = "Blood cells Concentration [umol/L]"
)  
...
plot(
  ...
  col = "blue",
  xlab = "Time [h]",
  ylab = "Heart concentration Concentration [umol/L]"
)  
