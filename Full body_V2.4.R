...

{
  ...
  PBPKModel = function(times, state, parameters) {
    with(as.list(c(state, parameters)), {
      ...
      dCmid_ict <-  ( 0.001 * PER * SA_mid * (Cheart_ec * fu_ec * funionized_ec - Cmid_ict/(Kp_mid * Kpp) * funionized_ic ) - Cmid_ict * fu_heart * CLint_heart * (Vmid_ic/Vhe) ) / Vmid_ic
      dCepi_ict <-  ( 0.001 * PER * SA_epi * (Cheart_ec * fu_ec * funionized_ec - Cepi_ict/(Kp_epi * Kpp) * funionized_ic ) - Cepi_ict * fu_heart * CLint_heart * (Vepi_ic/Vhe) ) / Vepi_ic 
