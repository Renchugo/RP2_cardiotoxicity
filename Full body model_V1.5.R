...

{
  ...
  PBPKModel = function(times, state, parameters) {
    with(as.list(c(state, parameters)), {
      ...
      Cliverfree <-  Cliver * fup  #liver free concentration
      Ckidneyfree <- Ckidney * fup #kidney free concentration
      Clung <- Alu / Vlu		   #lung
      ...
      # Mitochondrial bound concentration with mtDNA
      ...
      dAki <- Qki * (Carterial - Ckidney / Kpki * BP) #kidney
      dAli <- Qha * Carterial + Qgu * (Cgut / Kpgu * BP) + Qsp * (Cspleen / Kpsp * BP) - Qli * (Cliver / Kpli * BP) #liver
      ...
      dAve <- inf + Qad * (Cadipose / Kpad * BP) + Qbo * (Cbone / Kpbo * BP) + Qbr * (Cbrain / Kpbr * BP) + Qki* (Ckidney / Kpki * BP) + Qli * (Cliver / Kpli * BP) + Qmu* (Cmuscle / Kpmu * BP) + Qsk* (Cskin / Kpsk * BP)+ Qhe * (Cheart_ec / Kpec * BP) + Qre*(Crest / Kpre * BP) - Qlu * Cvenous - PER * SA_bloodcell * 0.1 * (Cvenous - Cbloodcell) - CL_total * Cvenous	* (fup / BP)	#venous blood
